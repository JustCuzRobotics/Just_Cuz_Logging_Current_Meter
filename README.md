...
| Max current | **150 A burst**, ~60 A continuous — limited by the XT60, not the sensor |
...
`verify.py` rebuilds the netlist **geometrically** — pins, wire endpoints and label anchors
